var TimeKnots = {
  draw: function(id, events, options){
    ...
    .attr("cx", function(d){
      ...
      tip.append("div").style("float", "left").html(dateValue ); //headertext
      tip.append("div").style("float", "center").html(d.text); // tryout for the text, center for the text in the middle and d.text in the other page for the value, -> create a new value in the array with d.text to implement it ...
      tip.transition()
      .duration(100)
      .style("opacity", .9);
